...
var _fastclick = __webpack_require__(150);

var _fastclick2 = _interopRequireDefault(_fastclick);

var _reactTapEventPlugin = __webpack_require__(178);
...
var _ListCore = __webpack_require__(151);
...
var _lazyimage = __webpack_require__(97);
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'section',
          { className: 'yo-tab yo-tab-filter m-filter' },
          _react2.default.createElement(
            'a',
            { href: '#', className: 'item item-x-ico' },
            '\u7EFC\u5408\u6392\u5E8F',
            _react2.default.createElement(
              'i',
              { className: 'yo-ico' },
          ...
          _react2.default.createElement(
            'a',
            { href: '#', className: 'item item-x-ico item-on' },
            '\u5168\u90E8\u53E3\u5473',
            _react2.default.createElement(
              'i',
              { className: 'yo-ico' },
...
var _src = __webpack_require__(153);
...
var Kinds = function (_React$Component) {
    ...
    function Kinds(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Kinds.__proto__ || Object.getPrototypeOf(Kinds)).call(this, props));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_src2.default, {
                    ...
                    renderItem: function renderItem(_ref3) {
                        ...
                        switch (itemType) {
                            case 'ProductMenu':
                                return _react2.default.createElement(ProductMenu, { data: data, isSpread: isSpread, index: index });
                        }
                    },
                    renderContent: function renderContent(_ref4) {
                        ...
                        switch (type) {
                            case 'product1':
                                return _react2.default.createElement(Product, { tit: 'product1' });
                            case 'product2':
                                return _react2.default.createElement(Product, { tit: 'product2' });
                        }
                    }
                })
            );
...
var _testdata = __webpack_require__(157);
...
function fetchDataOfSubway() {
    return new Promise(function (resolve) {
        window.setTimeout(function () {
            resolve(_testdata.subWayData[2]);
        }, 2000);
    });
}
...
var originalData = {
    subList: [{
        ...
        value: 'distance',
        subItemType: 'RADIO',
        subList: _testdata.distanceData,
        defaultValue: 0
    }, {
        name: '商圈',
        value: 'downtown',
        subItemType: 'RADIO',
        subList: _testdata.localData,
        defaultValue: 0
    }, {
        name: '行政区',
        value: 'region',
        subItemType: 'CHECKBOX',
        subList: _testdata.reginData,
        defaultValue: 0
    }, {
        name: '热门景点',
        value: 'scenic',
        ...
        subList: [{
            ...
            subItemType: 'RADIO',
            defaultValue: 0,
            subList: _testdata.toturistAttractionData.urban
        }, {
            value: 'nearby',
            name: '郊游景点',
            subItemType: 'RADIO',
            defaultValue: 0,
            subList: _testdata.toturistAttractionData.suburbs
        }]
    }, {
        value: 'traffic',
        name: '机场车站',
        subItemType: 'RADIO',
        subList: _testdata.trafficData,
        defaultValue: 0
    }, {
        value: 'subWay',
        name: '地铁线路',
        ...
        subList: [{
            ...
            subItemType: 'CHECKBOX',
            defaultValue: 0,
            subList: _testdata.subWayData[1]
        }, {
            value: '2',
            name: '2号线',
            subItemType: 'CHECKBOX',
...
var Kind = function (_React$Component) {
    ...
    _createClass(Kind, [{
        ...
        value: function handleValueChange(_ref) {
            var newValue = _ref.newValue,
            ...
            console.log(newItems.map(function (item) {
        ...
        key: 'handleRenderContent',
        value: function handleRenderContent() {
            console.log(0);
        }
    }, {
        key: 'handleAsyncData',
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.t0 = item.asyncType;
                                _context.next = _context.t0 === 'SUBWAY-2' ? 4 : 9;
                                break;

                            case 4:
                                _context.next = 6;
                                return fetchDataOfSubway();

                            case 6:
                                originalData.subList[5].subList[1].subList = _context.sent;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_src2.default, {
                    ...
                    onItemTap: function onItemTap() {
                        return _this2.handleItemTap();
                    },
                    onChange: this.handleValueChange.bind(this),
                    renderContent: this.handleRenderContent.bind(this)(),
...
/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("E:\\workspaces\\react-project\\node_modules\\.1.3.1@react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "kind1.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(106), __webpack_require__(11)))
...
var _reactAddonsShallowCompare = __webpack_require__(165);
...
var _aniScrollx = __webpack_require__(145);
...
var _carouselItem = __webpack_require__(146);
...
var _EventEmitter2 = __webpack_require__(149);
...
var __WEBPACK_AMD_DEFINE_RESULT__;/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("E:\\workspaces\\react-project\\node_modules\\.0.4.7@react-hot-api\\modules\\index.js"), RootInstanceProvider = require("E:\\workspaces\\react-project\\node_modules\\.1.3.1@react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react-dom/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
...
;(function () {
    ...
    if ("function" === 'function' && _typeof(__webpack_require__(105)) === 'object' && __webpack_require__(105)) {
...
/* WEBPACK VAR INJECTION */(function(process) {/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("E:\\workspaces\\react-project\\node_modules\\.0.4.7@react-hot-api\\modules\\index.js"), RootInstanceProvider = require("E:\\workspaces\\react-project\\node_modules\\.1.3.1@react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react-dom/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
...
var _ComponentCore2 = __webpack_require__(148);
...
var _src = __webpack_require__(98);

var _src2 = _interopRequireDefault(_src);

var _multilistitem = __webpack_require__(154);
...
var _multilistitem = __webpack_require__(156);
...
var trafficData = exports.trafficData = [{
    name: '不限',
    value: 0
}, {
    name: '北京南苑机场',
...
var localData = exports.localData = [{
    name: '不限',
    value: 0
}, {
    name: '首都机场',
...
var distanceData = exports.distanceData = [{
    name: '全城',
    value: 0
}, {
    name: '500m',
...
var reginData = exports.reginData = [{
    name: '不限',
    value: 0,
    itemType: 'RADIO'
}, {
...
var toturistAttractionData = exports.toturistAttractionData = {
    urban: [{
        name: '不限',
        value: 0
    }, {
...
var subWayData = exports.subWayData = {
    1: [{
        name: '不限',
        itemType: 'RADIO',
        value: 0
...
/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("E:\\workspaces\\react-project\\node_modules\\.1.3.1@react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "testdata.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
var _sticky = __webpack_require__(160);
...
var _gesture = __webpack_require__(161);
...
var _kind = __webpack_require__(139);

var _kind2 = _interopRequireDefault(_kind);

var _friends = __webpack_require__(136);

var _friends2 = _interopRequireDefault(_friends);

var _cart = __webpack_require__(135);

var _cart2 = _interopRequireDefault(_cart);

var _kind3 = __webpack_require__(140);

var _kind4 = _interopRequireDefault(_kind3);
...
_reactDom2.default.render(_react2.default.createElement(
	...
	_react2.default.createElement(
		...
		_react2.default.createElement(_reactRouter.Route, { path: 'my', component: _kind4.default })
	)
...
var shallowCompare = __webpack_require__(103);
...
/* WEBPACK VAR INJECTION */(function(process) {var invariant = __webpack_require__(43);
var defaultClickRejectionStrategy = __webpack_require__(177);
...
should be injected by the application.'
  ...
  __webpack_require__(99).injection.injectEventPluginsByName({
    'TapEventPlugin':       __webpack_require__(175)(shouldRejectClick)
  });
};
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(187));
